    ...
    <table class="table">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<td><button class="custom-button" class="btn btn-primary btn-sm custom-button" onclick="reserveHotel(' . $row["id"] . ')"><span class="text">Reserve this</span></button></td>';
                echo "</tr>";
            }
        } else {
...
<script>
    function reserveHotel(hotelId) {
        ...
        alert("Hotel " + hotelId + " reserved successfully!");
    }
</script>
